...
$email = $_GET['email'];             // get data sent from previous html form on index.php

$sql = "INSERT INTO users (name, email)
VALUES ('$fullName', '$email')"; // notice single quotes around variables because data is string. For integer or numbers we will not use single quotes.

if ($conn->query($sql) === TRUE) {
    echo "New record created successfully";
	header("location:main.php?fullName=$fullName&email=$email");
} else {
